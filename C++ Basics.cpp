...
class List {
    ...
    public:
        ...
        void add(int value) {
            ...
            if (head_node == NULL) {
                head_node = new_node;
                last_current_node = new_node;
            } else {
                last_current_node->setNext(new_node);
                last_current_node = new_node;
            }
        }
        ...
        friend List merge_lists(List odd_list, List even_list);
    };
    ...
    List merge_lists(List odd_list, List even_list) {
        List merged_list;

        Node* odd_current = odd_list.get();
        Node* even_current = even_list.get();

        while (odd_current != NULL) {
            merged_list.add(odd_current->get());
            odd_current = odd_current->getNext();
        }

        while (even_current != NULL) {
            merged_list.add(even_current->get());
            even_current = even_current->getNext();
        }
...
int main() {
    List input_list = addNodes();

    List odd_num;
    List even_num;

    Node* current = input_list.get();
...
// Even List
    ...
    List merged_list = merge_lists(odd_num, even_num);

// Merged List

    cout << "Merged List: "<< endl << endl;
